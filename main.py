...
st.markdown("""
    ...
    and the secondary stars have masses and radii of 0.56-0.66 solar masses and 0.52-0.62 solar radii. Because binary B caused 
    more dip (55%) than binaries A and C on the overall brightness of the system, I guess the size of primary star in binary B
    is bigger than other stars in the system.
    """)
