...
st.markdown("""
    ...
    more dip than binaries A and C on the overall brightness of the system, we can conclude that the order of the sizes of the primary stars in
    three binaries are: B > A > C.
    """)
