...
aperture_mask = tpf.create_threshold_mask(threshold=15)
aperture_mask
...
st.markdown("""
    With several lines of python code & LightKurve package ran on a laptop, the periods of the three eclipsing binaries 
